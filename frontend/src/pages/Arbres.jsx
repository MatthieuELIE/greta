  ...
  return (
    <div>
      ...
      <div className="mt-4 bg-zinc-100 mx-auto w-[90%] pb-8 pt-8 rounded-3xl text-roboto mb-12">
        ...
        <h2 className="text-lxl font-[700] text-left ml-8 pb-1 text-zinc-800 mb-4">
      ...
      <div>
        ...
        <img className="w-[95%] mx-auto" src="./src/assets/foret.png"
          width="auto" />
        <div className="flex flex-col text-center my-12 w-[90%] mx-auto">
          <div className="text-2xl font-[700] pb-8 text-zinc-800"><span className="mr-2 text-knw font-bold text-gradient">18 865</span>arbres déjà plantés</div>
          <div className="text-xl pb-4 text-zinc-800"><span className="mr-2 font-bold">56 293</span> abris pour animaux créés</div>
          <div className="text-xl pb-4 text-zinc-800"><span className="mr-2 font-bold">72 149</span> mois d'oxygène générés</div>
          <div className="text-xl pb-4 text-zinc-800"><span className="mr-2 font-bold">18 865</span> heures de travail realisées</div>
        </div>
        <div className="mt-4 bg-zinc-100 mx-auto w-[90%] pb-8 pt-4 rounded-3xl text-roboto mb-12 mt-8">
          ...
          <h3 className="text-2xl font-[700] text-center pb-1 text-zinc-800 mb-8 mt-4">Votre contribution </h3>
          <h4 className="text-xl text-center pb-2 text-zinc-800">🌳 2 arbres planté : <span className="font-[700]">félicitation !</span></h4>
          <h4 className="text-xl text-center pb-2 text-zinc-800">☁️ 13,5 tonnes de co2 stockés</h4>
          <h4 className="text-xl text-center pb-2 text-zinc-800">🐦 1 abris pour animaux créés</h4>
