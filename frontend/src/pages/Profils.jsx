        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
              ...
              <div>
                ...
                <span class="block text-center text-gray-500">
                  par rapport au mois dernier au même jour{" "}
                </span>
              </div>
              <table class="w-full text-gray-600">
                <tbody>
                  <tr>
                    <td class="py-2">Mars</td>
                    <td class="text-gray-500">91</td>
                    <td>
                      <svg
                        class="w-16 ml-auto"
                        viewBox="0 0 68 21"
                  ...
                  <tr>
                    <td class="py-2">Avril</td>
                    <td class="text-gray-500">155</td>
                    <td>
                      <svg
                        class="w-16 ml-auto"
                        viewBox="0 0 68 21"
                  ...
                  <tr>
                    <td class="py-2">Mai</td>
                    <td class="text-gray-500">37    </td>
                    <td>
                      <svg
                        class="w-16 ml-auto"
                        viewBox="0 0 68 21"
          ...
          <div>
            <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
              <h5 class="text-xl text-gray-700">Compare tes économies avec tes amies</h5>
              <div class="my-8">
                <h1 class="text-5xl font-bold text-gray-800">Jean-Eude vs Michel</h1>
                <span class="text-gray-500">Mois en cours</span>
              </div>
              <svg
                class="w-full"
                viewBox="0 0 218 69"
