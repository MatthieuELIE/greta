  ...
  return (
    <div className="ProfilsPage">
      ...
      <div className="bg-zinc-100 mx-auto w-[90%] pb-8 pt-8 rounded-3xl text-roboto mb-12">
        <h1 className="text-3xl text-center font-[700] pb-1">Thomas Thumberg</h1>
        ...
        <div className="flex flex-col text-center justify-centert">
          ...
          <p className="mt-2 bg-zinc-200 p-2 rounded-3xl w-[90%] mx-auto">A économisé <span className="text-xl font-[900] mx-1 text-lime-700">58kg de CO2</span> depuis le 13/02/2022</p>
        </div>
      </div>
      <div className="Quêtes-journalières text-roboto">
        <h1 className="text-roboto text-3xl font-[700] text-left ml-8 pb-4">Quêtes quotidiennes validées ✅</h1>
      ...
      <div className="Quêtes-terminés text-roboto">
        <h1 className="text-roboto text-3xl font-[700] text-left ml-8 pb-4">Quêtes hebdo validées ✅</h1>
        <p className="mb-12 text-xl ml-8 my-6">● Changer sa chaudière pour une chaudière hybride</p>
      </div>
    </div>
  );
}
