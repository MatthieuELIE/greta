  ...
  return (
    <div className="ProfilsPage">
        ...
        <div className="Quêtes-journalières">
          <h1 className="text-roboto text-3xl font-[700] text-left ml-8">Quêtes journalières</h1>
        ...
        <div className="Quêtes-terminés">
          <h1 className="text-roboto text-3xl font-[700] text-left ml-8">Quêtes validés de la semaine</h1>
...
<p className="italic">Changer sa chaudiere pour une chaudiere hybride</p>
</div>
